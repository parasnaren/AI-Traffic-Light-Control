...
def import_train_configuration(config_file):
    ...
    config['width_layers'] = content['agent'].getint('width_layers')
    config['batch_size'] = content['agent'].getint('batch_size')
    config['learning_rate'] = content['agent'].getfloat('learning_rate')
    config['training_epochs'] = content['agent'].getint('training_epochs')
    config['with_per'] = content['agent'].getboolean('with_per')
    config['dueling'] = content['agent'].getboolean('dueling')
    config['buffer_size'] = content['agent'].getint('buffer_size')
    ...
    config['model_path'] = content['model']['model_path']
